...
interface NormalizedSchema extends PluginLibGeneratorSchema {
  projectName: string;
  projectRoot: string;
...
function normalizeOptions(tree: Tree, options: PluginLibGeneratorSchema): NormalizedSchema {
...
export default async function (tree: Tree, options: PluginLibGeneratorSchema) {
